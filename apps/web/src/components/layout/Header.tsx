...
import { Bell, Search, Sun, Moon, ChevronDown, Globe, Settings, Heart, UserCheck, Calendar, LogOut } from 'lucide-react';
...
export function Header() {
  const { user, getOrgPersona, isOrgAdmin, isSuperAdmin, signOut } = usePlatformAuth();
