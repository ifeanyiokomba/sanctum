...
export function ToastProviderWrapper({ children }: { children: React.ReactNode }) {
  ...
  const addToast = useCallback((toast: Omit<ToastProps, "id"> & { id?: string }) => {
...
export function Toaster() {
  ...
  return (
    <ToastViewport>
      {toasts.map(({ id, variant = "default", title, description, action, ...props }) => (
        <Toast key={id} variant={variant} description={description} action={action} {...props}>
